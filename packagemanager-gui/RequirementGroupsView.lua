...
function RequirementGroupsView:_createRequirementAddButton( group )
    ...
    utils.connect(addButton, 'command_button_clicked', function()
...
function RequirementGroupsView:addGroup( groupName )
    ...
    utils.connect(nameTextCtrl, 'kill_focus', function()
        self.renameGroupEvent(group, nameTextCtrl:GetValue())
    end)
    utils.connect(nameTextCtrl, 'command_text_enter', function()
        self.renameGroupEvent(group, nameTextCtrl:GetValue())
    end)
    utils.connect(nameTextCtrl, 'command_text_updated', function()
    ...
    utils.connect(deleteButton, 'command_button_clicked', function()
    ...
    utils.connect(createButton, 'command_button_clicked', function()
